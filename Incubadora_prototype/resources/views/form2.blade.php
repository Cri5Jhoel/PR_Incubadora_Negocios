...
<script type="text/javascript">
    ...
    app.controller('myCtrl', function($scope, $http) {
        ...
        $scope.myFunc = function() {
            document.getElementById("input25").value = document.getElementById("input17").value;
            document.getElementById("input67").value = document.getElementById("input17").value;


            document.getElementById("input29").value = document.getElementById("input18").value;
            document.getElementById("input88").value = document.getElementById("input18").value;

            document.getElementById("input33").value = document.getElementById("input19").value;
            document.getElementById("input109").value = document.getElementById("input19").value;

            document.getElementById("input37").value = document.getElementById("input20").value;
            document.getElementById("input130").value = document.getElementById("input20").value;
            
            document.getElementById("input41").value = document.getElementById("input21").value;
            document.getElementById("input151").value = document.getElementById("input21").value;
            
            document.getElementById("input45").value = document.getElementById("input22").value;

            
            document.getElementById("input49").value = document.getElementById("input23").value;

            
            document.getElementById("input53").value = document.getElementById("input24").value;


            document.getElementById("input68").value = document.getElementById("input57").value;
            document.getElementById("input89").value = document.getElementById("input57").value;
            document.getElementById("input110").value = document.getElementById("input57").value;
            document.getElementById("input131").value = document.getElementById("input57").value;
            document.getElementById("input152").value = document.getElementById("input57").value;

            document.getElementById("input72").value = document.getElementById("input59").value;
            document.getElementById("input93").value = document.getElementById("input59").value;
            document.getElementById("input114").value = document.getElementById("input59").value;
            document.getElementById("input135").value = document.getElementById("input59").value;
            document.getElementById("input156").value = document.getElementById("input59").value;

            document.getElementById("input76").value = document.getElementById("input61").value;
            document.getElementById("input97").value = document.getElementById("input61").value;
            document.getElementById("input118").value = document.getElementById("input61").value;
            document.getElementById("input139").value = document.getElementById("input61").value;
            document.getElementById("input160").value = document.getElementById("input61").value;

            document.getElementById("input80").value = document.getElementById("input63").value;
            document.getElementById("input101").value = document.getElementById("input63").value;
            document.getElementById("input122").value = document.getElementById("input63").value;
            document.getElementById("input143").value = document.getElementById("input63").value;
            document.getElementById("input164").value = document.getElementById("input63").value;

            document.getElementById("input84").value = document.getElementById("input65").value;
            document.getElementById("input105").value = document.getElementById("input65").value;
            document.getElementById("input126").value = document.getElementById("input65").value;
            document.getElementById("input147").value = document.getElementById("input65").value;
            document.getElementById("input168").value = document.getElementById("input65").value;
        };
    });
</script>
