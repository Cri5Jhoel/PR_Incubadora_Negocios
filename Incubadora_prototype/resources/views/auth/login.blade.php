        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <input id="firstName" placeholder="Nombre" type="text" class="form-control @error('name') is-invalid @enderror" name="firstName" value="{{ old('firstName') }}" required autocomplete="firstName" autofocus>
                    ...
                    <input id="lastName" placeholder="Apellido Paterno" type="text" class="form-control " name="lastName" value="{{ old('lastName') }}" required autocomplete="lastName" autofocus>


                    <input id="secondLastName" placeholder="Apellido Materno" type="text" class="form-control" name="secondLastName" value="{{ old('secondLastName') }}" required autocomplete="secondLastName" autofocus>
