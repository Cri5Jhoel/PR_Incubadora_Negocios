                        ...
                        <div class="row">
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check1" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check2" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check3" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check4" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check5" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check6" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check7" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check8" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check9" value="1" type="checkbox"
                            ...
                            <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                <div class="checkbox-container">
                                    <input class="app-antepnp" name="check10" value="1" type="checkbox"
                    ...
                    <div id="producto2">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check11" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check12" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check13" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check14" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check15" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check16" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check17" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check18" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check19" value="1" type="checkbox"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check20" value="1" type="checkbox"
                    ...
                    <div id="producto3">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check21" ng-model="input249"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check22" ng-model="input250"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check23" ng-model="input251"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check24" ng-model="input252"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check25" ng-model="input253"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check26" ng-model="input254"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check27" ng-model="input255"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check28" ng-model="input256"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check29" ng-model="input257"
                                ...
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check30" ng-model="input258"
                ...
                angular.element(document).ready(() => {
                    ...
                    if (userType == "teacher") {
                        ...
                        $http.get('/verifiedTeacher/'+teamId).then((res) =>{
                            ...
                            var newStatusAprob = s[0]+ "," + s[1] + "," + s[2] + ",3,1,"+s[5] + ","+s[6];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\teran\Downloads\Incubadora_prototype_SJ\resources\views/form4.blade.php ENDPATH**/ ?>