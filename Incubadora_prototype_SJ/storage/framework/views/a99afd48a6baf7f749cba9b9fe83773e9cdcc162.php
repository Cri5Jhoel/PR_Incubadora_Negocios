        ...
        <div class="card bg-secondary text-white shadow">
            <div id="content" class="card-body">
                <form action="#" class="form">
                    ...
                    <div>
                        <div class="table-responsive">
                            <h5>De entre y razones y causas que has enumerado, elige aquellos que quieras que tu negocio
                                resuelva</h5>
                            <table class="table text-white table-borderless">
                                <thead>
                                    <tr>
                    ...
                    <div>
                        <div class="mb-3">
                            <h4 for="" class="text-left">Utiliza la descripción de tu solución para crear tu
                                producto/servicio.</h4>
                    ...
                    <div>
                        <div class="mb-3">
                            <h4 for="" class="text-left">Enumera todos los problemas que se encuentran tus clientes en
                    ...
                    <div>
                        <div class="mb-3">
                            <h4 for="" class="text-left">Haz una estimación del tamaño del mercado para cada uno de tus
                    ...
                    <div>
                        ...
                        <div class="table-responsive">
                            <h4>¿Cómo de insatisfecho está este segmento de mercado con la oferta de mercado actual para
...
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_Jaldin\Incubadora_prototype_SJ\resources\views/form1.blade.php ENDPATH**/ ?>