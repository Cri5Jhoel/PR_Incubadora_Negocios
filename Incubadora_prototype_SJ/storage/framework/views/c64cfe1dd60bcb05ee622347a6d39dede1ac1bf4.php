                ...
                <form action="#" class="form">
                    ...
                    <div>
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input97" id="input97" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" name="" ng-model="input98" id="input98" aria-describedby="helpId" placeholder=""></textarea>
                        </div>
                    </div>
                    <div id="producto2">

                        <input type="text" class="form-control" name="" ng-model="product2" id="product2" aria-describedby="helpId" placeholder="" readonly>
                        <h4 class="text-center app-subtitle">Responde a las siguientes preguntas evaluando en qué punto de la escala se encuentra cada segmento de cliente</h4>
                        <div>
                            <div>
                                <h4>¿Este segmento de mercado paga por nuestro producto o servicio?</h4>
                                <div class="row">
                                    ...
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio10" ng-model="input100" id="input100" value="option1">
                                            <label class="form-check-label" for="radio1">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio10" ng-model="input101" id="input101" value="option2">
                                            <label class="form-check-label" for="radio1">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio10" ng-model="input102" id="input102" value="option3">
                                            <label class="form-check-label" for="radio1">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio10" ng-model="input103" id="input103" value="option4">
                                            <label class="form-check-label" for="radio1">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio10" ng-model="input104" id="input104" value="option5">
                                            <label class="form-check-label" for="radio1">Sí</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio11" ng-model="input106" id="input106" value="option1">
                                            <label class="form-check-label" for="radio2">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio11" ng-model="input107" id="input107" value="option2">
                                            <label class="form-check-label" for="radio2">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio11" ng-model="input108" id="input108" value="option3">
                                            <label class="form-check-label" for="radio2">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio11" ng-model="input109" id="input109" value="option4">
                                            <label class="form-check-label" for="radio2">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio11" ng-model="input110" id="input110" value="option5">
                                            <label class="form-check-label" for="radio2">Sí</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio12" ng-model="input112" id="input112" value="option1">
                                            <label class="form-check-label" for="radio3">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio12" ng-model="input113" id="input113" value="option2">
                                            <label class="form-check-label" for="radio3">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio12" ng-model="input114" id="input114" value="option3">
                                            <label class="form-check-label" for="radio3">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio12" ng-model="input115" id="input115" value="option4">
                                            <label class="form-check-label" for="radio3">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio12" ng-model="input116" id="input116" value="option5">
                                            <label class="form-check-label" for="radio3">Sí</label>
                                        </div>
                                    </div>
                                    <h4>¿Con qué frecuencia paga este segmento?</h4>
                                    <div class="row">
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio13" ng-model="input118" id="input118" value="option1">
                                                <label class="form-check-label" for="radio4">No</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio13" ng-model="input119" id="input119" value="option2">
                                                <label class="form-check-label" for="radio4">No mucho</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio13" ng-model="input120" id="input120" value="option3">
                                                <label class="form-check-label" for="radio4">N/S</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio13" ng-model="input121" id="input121" value="option4">
                                                <label class="form-check-label" for="radio4">Probablemente</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio13" ng-model="input122" id="input122" value="option5">
                                                <label class="form-check-label" for="radio4">Sí</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio14" ng-model="input124" id="input124" value="option1">
                                                <label class="form-check-label" for="radio5">No</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio14" ng-model="input125" id="input125" value="option2">
                                                <label class="form-check-label" for="radio5">No mucho</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio14" ng-model="input126" id="input126" value="option3">
                                                <label class="form-check-label" for="radio5">N/S</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio14" ng-model="input127" id="input127" value="option4">
                                                <label class="form-check-label" for="radio5">Probablemente</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio14" ng-model="input128" id="input128" value="option5">
                                                <label class="form-check-label" for="radio5">Sí</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio15" ng-model="input130" id="input130" value="option1">
                                                <label class="form-check-label" for="radio6">No</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio15" ng-model="input131" id="input131" value="option2">
                                                <label class="form-check-label" for="radio6">No mucho</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio15" ng-model="input132" id="input132" value="option3">
                                                <label class="form-check-label" for="radio6">N/S</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio15" ng-model="input133" id="input133" value="option4">
                                                <label class="form-check-label" for="radio6">Probablemente</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio15" ng-model="input134" id="input134" value="option5">
                                                <label class="form-check-label" for="radio6">Sí</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio16" ng-model="input136" id="input136" value="option1">
                                                <label class="form-check-label" for="radio7">Varios intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio16" ng-model="input137" id="input137" value="option2">
                                                <label class="form-check-label" for="radio7">Dos intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio16" ng-model="input138" id="input138" value="option3">
                                                <label class="form-check-label" for="radio7">Un intermediario</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio16" ng-model="input139" id="input139" value="option4">
                                                <label class="form-check-label" for="radio7">Venta directa</label>
                                            </div>
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio17" ng-model="input141" id="input141" value="option1">
                                                <label class="form-check-label" for="radio8">Varios intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio17" ng-model="input142" id="input142" value="option2">
                                                <label class="form-check-label" for="radio8">Dos intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio17" ng-model="input143" id="input143" value="option3">
                                                <label class="form-check-label" for="radio8">Un intermediario</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio17" ng-model="input144" id="input144" value="option4">
                                                <label class="form-check-label" for="radio8">Venta directa</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio18" ng-model="input146" id="input146" value="option1">
                                                <label class="form-check-label" for="radio9">Varios intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio18" ng-model="input147" id="input147" value="option2">
                                                <label class="form-check-label" for="radio9">Dos intermediarios</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio18" ng-model="input148" id="input148" value="option3">
                                                <label class="form-check-label" for="radio9">Un intermediario</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="radio18" ng-model="input149" id="input149" value="option4">
                                                <label class="form-check-label" for="radio9">Venta directa</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="row">
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check11" value="1" type="checkbox" ng-model="input150" id="input150">
                                        <label for="check11">Venta directa</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check12" value="1" type="checkbox" ng-model="input151" id="input151">
                                        <label for="check12">Suscripción</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check13" value="1" type="checkbox" ng-model="input152" id="input152">
                                        <label for="check13">Pay as you Go</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check14" value="1" type="checkbox" ng-model="input153" id="input153">
                                        <label for="check14">Alquiler</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check15" value="1" type="checkbox" ng-model="input154" id="input154">
                                        <label for="check15">Broker</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check16" value="1" type="checkbox" ng-model="input155" id="input155">
                                        <label for="check16">Low-Touch</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check17" value="1" type="checkbox" ng-model="input156" id="input156">
                                        <label for="check17">Saas</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check18" value="1" type="checkbox" ng-model="input157" id="input157">
                                        <label for="check18">Modelo de datos</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check19" value="1" type="checkbox" ng-model="input158" id="input158">
                                        <label for="check19">Modelo de publicidad</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input class="app-antepnp" name="check20" value="1" type="checkbox" ng-model="input159" id="input159">
                        ...
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">Escribe una breve descripción de lo que te interesa de cada uno de los modelos de negocio que has seleccionado.</h4>
                                <textarea type="text" class="form-control" name="" ng-model="input160" id="input160" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input161" id="input161" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input162" id="input162" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input163" id="input163" rows="3"></textarea>
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Creación del modelo de negocios</h4>
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">Crea y define el mejor modelo de negocio para cada segmento de mercado seleccionando los modelos que te interesen de la lista (máx. 3) y escribe una breve descripción.</h4>
                                <textarea type="" class="form-control " name="" ng-model="input164" id="input164" rows="3"></textarea>
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Embudo de MKT</h4>
                        <div>
                            <h4>Parte superior del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input165" id="input165" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input166" id="input166" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input167" id="input167" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input168" id="input168" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input169" id="input169" placeholder="">
                            </div>
                            <h4>Parte media del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input170" id="input170" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input171" id="input171" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input172" id="input172" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input173" id="input173" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input174" id="input174" placeholder="">
                            </div>
                            <h4>Parte inferior del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input175" id="input175" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input176" id="input176" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input177" id="input177" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input178" id="input178" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input179" id="input179" placeholder="">
                            </div>
                            <div class="table-responsive">
                                <h4>Selecciona las actividades en las que deseas centrarte en cada nivel del embudo.</h4>
                                <table class="table text-white table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input180" id="input180" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input181" id="input181" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input182" id="input182" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input183" id="input183" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input184" id="input184" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input185" id="input185" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input186" id="input186" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input187" id="input187" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input188" id="input188" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input189" id="input189" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input190" id="input190" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input191" id="input191" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos visitantes esperas recibir al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input192" id="input192" placeholder="Ejemplo: 1000">
                            </div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos clientes potenciales, esperas obtener al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input193" id="input193" placeholder="Ejemplo: 100">
                            </div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos clientes reales, esperas obtener al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input194" id="input194" placeholder="Ejemplo: 100">
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Ahora calculemos el CAC</h4>
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">¿Cuánto te costará llevar a cabo todas las actividades de marketing en un mes?</h4>
                                <input type="text" class="form-control" name="" ng-change="func1p2()" ng-model="input195" id="input195" placeholder="">
                            </div>
                            <div class="table-responsive">
                                <table class="table text-white table-borderless">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input196" id="input196" placeholder="" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="mb-3">
                                <h4 for="" class="text-left">Ahora explica por qué el modelo que has elegido es el adecuado y cómo planeas llegar a ellos.</h4>
                                <textarea type="text" class="form-control" name="" ng-model="input197" id="input197" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                    <div id="producto3">
                        <input type="text" class="form-control" name="" ng-model="product3" id="product3" aria-describedby="helpId" placeholder="" readonly>
                        <h4 class="text-center app-subtitle">Responde a las siguientes preguntas evaluando en qué punto de la escala se encuentra cada segmento de cliente</h4>
                        <div>
                            <div>
                                <h4>¿Este segmento de mercado paga por nuestro producto o servicio?</h4>
                                <div class="row">
                                    <input type="text" class="form-control" name="" ng-model="input198" id="input198" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio19" ng-model="input199" id="input199" value="option1">
                                            <label class="form-check-label" for="radio19">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio19" ng-model="input200" id="input200" value="option2">
                                            <label class="form-check-label" for="radio19">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio19" ng-model="input201" id="input201" value="option3">
                                            <label class="form-check-label" for="radio19">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio19" ng-model="input202" id="input202" value="option4">
                                            <label class="form-check-label" for="radio19">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio19" ng-model="input203" id="input203" value="option5">
                                            <label class="form-check-label" for="radio19">Sí</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input204" id="input204" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio20" ng-model="input205" id="input205" value="option1">
                                            <label class="form-check-label" for="radio20">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio20" ng-model="input206" id="input206" value="option2">
                                            <label class="form-check-label" for="radio20">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio20" ng-model="input207" id="input207" value="option3">
                                            <label class="form-check-label" for="radio20">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio20" ng-model="input208" id="input208" value="option4">
                                            <label class="form-check-label" for="radio20">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio20" ng-model="input209" id="input209" value="option5">
                                            <label class="form-check-label" for="radio20">Sí</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input210" id="input210" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio21" ng-model="input211" id="input211" value="option1">
                                            <label class="form-check-label" for="radio21">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio21" ng-model="input212" id="input212" value="option2">
                                            <label class="form-check-label" for="radio21">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio21" ng-model="input213" id="input213" value="option3">
                                            <label class="form-check-label" for="radio21">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio21" ng-model="input214" id="input214" value="option4">
                                            <label class="form-check-label" for="radio21">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio21" ng-model="input215" id="input215" value="option5">
                                ...
                                <h4>¿Con qué frecuencia paga este segmento?</h4>
                                <div class="row">
                                    <input type="text" class="form-control" name="" ng-model="input216" id="input216" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio22" ng-model="input217" id="input217" value="option1">
                                            <label class="form-check-label" for="radio22">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio22" ng-model="input218" id="input218" value="option2">
                                            <label class="form-check-label" for="radio22">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio22" ng-model="input219" id="input219" value="option3">
                                            <label class="form-check-label" for="radio22">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio22" ng-model="input220" id="input220" value="option4">
                                            <label class="form-check-label" for="radio22">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio22" ng-model="input221" id="input221" value="option5">
                                            <label class="form-check-label" for="radio22">Si</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input222" id="input222" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio23" ng-model="input223" id="input223" value="option1">
                                            <label class="form-check-label" for="radio23">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio23" ng-model="input224" id="input224" value="option2">
                                            <label class="form-check-label" for="radio23">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio23" ng-model="input225" id="input225" value="option3">
                                            <label class="form-check-label" for="radio23">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio23" ng-model="input226" id="input226" value="option4">
                                            <label class="form-check-label" for="radio23">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio23" ng-model="input227" id="input227" value="option5">
                                            <label class="form-check-label" for="radio23">Si</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input228" id="input228" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio24" ng-model="input229" id="input229" value="option1">
                                            <label class="form-check-label" for="radio24">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio24" ng-model="input230" id="input230" value="option2">
                                            <label class="form-check-label" for="radio24">No mucho</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio24" ng-model="input231" id="input231" value="option3">
                                            <label class="form-check-label" for="radio24">N/S</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio24" ng-model="input232" id="input232" value="option4">
                                            <label class="form-check-label" for="radio24">Probablemente</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio24" ng-model="input233" id="input233" value="option5">
                                ...
                                <h4>¿Vendes directamente a este segmento de mercado?</h4>
                                <div class="row">
                                    <input type="text" class="form-control" name="" ng-model="input234" id="input234" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio25" ng-model="input235" id="input235" value="option1">
                                            <label class="form-check-label" for="radio25">Varios intermediarios</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio25" ng-model="input236" id="input236" value="option2">
                                            <label class="form-check-label" for="radio25">Dos intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio25" ng-model="input237" id="input237" value="option3">
                                            <label class="form-check-label" for="radio25">Un intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio25" ng-model="input238" id="input238" value="option4">
                                            <label class="form-check-label" for="radio25">Venta directa</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input239" id="input239" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio26" ng-model="input240" id="input240" value="option1">
                                            <label class="form-check-label" for="radio26">Varios intermediarios</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio26" ng-model="input241" id="input241" value="option2">
                                            <label class="form-check-label" for="radio26">Dos intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio26" ng-model="input242" id="input242" value="option3">
                                            <label class="form-check-label" for="radio26">Un intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio26" ng-model="input243" id="input243" value="option4">
                                            <label class="form-check-label" for="radio26">Venta directa</label>
                                        </div>
                                    </div>

                                    <input type="text" class="form-control" name="" ng-model="input244" id="input244" placeholder="">
                                    <div class="flex">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio27" ng-model="input245" id="input245" value="option1">
                                            <label class="form-check-label" for="radio27">Varios intermediarios</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio27" ng-model="input246" id="input246" value="option2">
                                            <label class="form-check-label" for="radio27">Dos intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio27" ng-model="input247" id="input247" value="option3">
                                            <label class="form-check-label" for="radio27">Un intermediario</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="radio27" ng-model="input248" id="input248" value="option4">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check21" ng-model="input249" id="input249" value="option1">
                                        <label for="checkbox1">Venta directa</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check22" ng-model="input250" id="input250" value="option2">
                                        <label for="checkbox2">Suscripción</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check23" ng-model="input251" id="input251" value="option3">
                                        <label for="checkbox3">Pay as you go</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check24" ng-model="input252" id="input252" value="option4">
                                        <label for="checkbox4">Alquiler</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check25" ng-model="input253" id="input253" value="option5">
                                        <label for="checkbox5">Broker</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check26" ng-model="input254" id="input254" value="option6">
                                        <label for="checkbox6">Low-Touch</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check27" ng-model="input255" id="input255" value="option7">
                                        <label for="checkbox7">Saas</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check28" ng-model="input256" id="input256" value="option8">
                                        <label for="checkbox8">Modelo de datos</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check29" ng-model="input257" id="input257" value="option9">
                                        <label for="checkbox9">Modelo de publicidad</label>
                                    </div>
                                </checkbox>
                                <checkbox class="form-group col-lg-4 col-md-3 col-sm-4 col-6">
                                    <div class="checkbox-container">
                                        <input type="checkbox" class="app-antepnp" name="check30" ng-model="input258" id="input258" value="option10">
                        ...
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">Escribe una breve descripción de lo que te interesa de cada uno de los modelos de negocio que has seleccionado.</h4>
                                <textarea type="text" class="form-control" name="" ng-model="input259" id="input259" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input260" id="input260" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input261" id="input261" rows="3"></textarea>
                                <textarea type="text" class="form-control" name="" ng-model="input262" id="input262" rows="3"></textarea>
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Creación del modelo de negocios</h4>
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">Crea y define el mejor modelo de negocio para cada segmento de mercado seleccionando los modelos que te interesen de la lista (máx. 3) y escribe una breve descripción.</h4>
                                <textarea type="text" class="form-control" name="" ng-model="input263" id="input263" rows="3"></textarea>
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Embudo de MKT</h4>
                        <div>
                            <h4>Parte superior del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input264" id="input264" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input265" id="input265" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input266" id="input266" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input267" id="input267" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input268" id="input268" placeholder="">
                            </div>
                            <h4>Parte media del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input269" id="input269" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input270" id="input270" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input271" id="input271" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input272" id="input272" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input273" id="input273" placeholder="">
                            </div>
                            <h4>Parte inferior del embudo</h4>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="" ng-model="input274" id="input274" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input275" id="input275" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input276" id="input276" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input277" id="input277" placeholder="">
                                <input type="text" class="form-control" name="" ng-model="input278" id="input278" placeholder="">
                            </div>
                            <div class="table-responsive">
                                <h4>Selecciona las actividades en las que deseas centrarte en cada nivel del embudo.</h4>
                                ...
                                <table class="table text-white table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input279" id="input279" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input280" id="input280" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input281" id="input281" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input282" id="input282" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input283" id="input283" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input284" id="input284" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input285" id="input285" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input286" id="input286" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input287" id="input287" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input288" id="input288" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input289" id="input289" placeholder="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input290" id="input290" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos visitantes esperas recibir al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input291" id="input291" placeholder="Ejemplo: 100">
                            </div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos clientes potenciales, esperas obtener al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input292" id="input292" placeholder="Ejemplo: 100">
                            </div>
                            <div class="mb-3">
                                <h4 for="" class="form-label">¿Cuántos clientes reales, esperas obtener al mes?</h4>
                                <input type="text" class="form-control" name="" ng-model="input293" id="input293" placeholder="Ejemplo: 100">
                            </div>
                        </div>
                        <h4 class="text-center app-subtitle">Ahora calculemos el CAC</h4>
                        <div>
                            <div class="mb-3">
                                <h4 for="" class="text-left">¿Cuánto te costará llevar a cabo todas las actividades de marketing en un mes?</h4>
                                <input type="text" class="form-control" name="" ng-change="func1p3() " ng-model="input294" id="input294" placeholder="">
                            </div>
                            <div class="table-responsive">
                                <table class="table text-white table-borderless">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <input type="text" class="form-control" name="" ng-model="input295" id="input295" placeholder="" disabled>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="mb-3">
                                <h4 for="" class="text-left">Ahora explica por qué el modelo que has elegido es el adecuado y cómo planeas llegar a ellos.</h4>
                                <textarea type="text" class="form-control" name="" ng-model="input296" id="input296" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            var formNumber = 4;
                    ...
                    $scope.func1 = function() {
                        ...
                        if (/[a-zA-Z]/.test(document.getElementById("input96").value)) {
                            ...
                            $scope.input97 = document.getElementById("input96").value / document.getElementById("input95").value;
                        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_Jaldin\Incubadora_prototype_SJ\resources\views/form4.blade.php ENDPATH**/ ?>