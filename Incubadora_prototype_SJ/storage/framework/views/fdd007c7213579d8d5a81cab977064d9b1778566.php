        ...
        <div class="card text-white shadow backgroundBlack">
            <div id="content" class="card-body">
                ...
                <form action="#" class="form">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Metas y aspiraciones</h4>
                    <div>
                        <div class="mb-3">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Valores y Cultura</h4>
                    <div>
                        <div class="mb-3">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Indicadores clave de rendimiento</h4>
                    <div>
                        <div class="mb-3">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Hitos</h4>
                    <div>
                        <div class="table-responsive">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Potenciales riesgos</h4>
                    <div>
                        <div class="mb-3">
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Equipo de tus sueños</h4>
                    <div>
                    ...
                    <h4 class="text-center app-subtitle subtitleGreen">Plan de crecimiento</h4>
                    <div>
                        <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_Jaldin\Incubadora_prototype_SJ\resources\views/form7.blade.php ENDPATH**/ ?>