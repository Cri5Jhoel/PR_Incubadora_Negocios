            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home#">
                    <div class="sidebar-brand-icon">
                        <image src="<?php echo e(asset('images/univalle_logo.png')); ?>" style="height: 50px; width: 50px;"></i>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTimes" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="/listtimes">Vista de fechas</a>
                            <a class="collapse-item" href="/newtime">Agregar fechas</a>
                        </div>
                    </div>
                </li>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Auth::user()->firstName); ?> <?php echo e(Auth::user()->lastName); ?> <?php echo e(Auth::user()->secondLastName); ?></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('changePass')); ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a  href="<?php echo e(route('logout')); ?>" id="especial" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <button class="btn btn-primary" type="button" id="especial1" data-dismiss="modal"> <?php echo e(__('Cerrar Session')); ?></button>
                        </a>
                        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
                            <?php echo csrf_field(); ?>
                        </form>
                        <button class="btn btn-secondary" id="especial2" type="button" data-dismiss="modal">Cancelar</button>
...
<?php /**PATH C:\Users\teran\Downloads\Incubadora_prototype_SJ\resources\views/layouts/Dashboard.blade.php ENDPATH**/ ?>