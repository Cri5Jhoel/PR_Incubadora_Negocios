                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <form class="user" method="POST" action="<?php echo e(route('forgotPassword')); ?>">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_prototype_Valdivia\Incubadora_prototype\resources\views/auth/passwords/forgot.blade.php ENDPATH**/ ?>