...
<script type="text/javascript">
    ...
    app.controller('myCtrl', function($scope, $http) {
        ...
        $scope.parseArrayValues1 = () => {
            ...
            let formText4 = $scope.forms4.formText;
            let formTextArray4 = formText4.split(";");
            $scope.form4 = formTextArray4[97];
            $scope.form4p2 = formTextArray4[196];
            $scope.form4p3 = formTextArray4[295];
        ...
        $scope.func1p2 = function() {
            ...
            $scope.input24p2 = document.getElementById("input19p2").value / $scope.form4p2;
        }
        $scope.func1p3 = function() {
            ...
            $scope.input24p3 = document.getElementById("input19p3").value / $scope.form4p3;
        }
    });
</script>
                    ...
                    <div id="producto2">
                        ...
                        <div>
                            <div class="">
                                <div class="mb-3">
                                    <label for="" class="form-label">Frecuencia</label>
                                    <input type="text" class="form-control" name="" ng-model="input16p2" id="input16p2" aria-describedby="helpId" placeholder="" ng-change="func1p2()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Duración</label>
                                    <input type="text" class="form-control" name="" ng-model="input17p2" id="input17p2" aria-describedby="helpId" placeholder="" ng-change="func1p2()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Valor del pedido</label>
                                    <input type="text" class="form-control" name="" ng-model="input18p2" id="input18p2" aria-describedby="helpId" placeholder="" ng-change="func1p2()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">LTV</label>
                    ...
                    <div id="producto3">
                        ...
                        <div>
                            <div class="">
                                <div class="mb-3">
                                    <label for="" class="form-label">Frecuencia</label>
                                    <input type="text" class="form-control" name="" ng-model="input16p3" id="input16p3" aria-describedby="helpId" placeholder="" ng-change="func1p3()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Duración</label>
                                    <input type="text" class="form-control" name="" ng-model="input17p3" id="input17p3" aria-describedby="helpId" placeholder="" ng-change="func1p3()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Valor del pedido</label>
                                    <input type="text" class="form-control" name="" ng-model="input18p3" id="input18p3" aria-describedby="helpId" placeholder="" ng-change="func1p3()">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">LTV</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_Jaldin\Incubadora_prototype_SJ\resources\views/form5.blade.php ENDPATH**/ ?>