										...
										<tr>
											...
											<td width="300" style="width: 30%;" align="center">
												<a href="#" target="_blank" border="0" style="border: none; display: block; outline: none; text-decoration: none; line-height: 60px; height: 60px; color: #ffffff; font-family: Verdana, Geneva, sans-serif;  -webkit-text-size-adjust:none;">
													<images src="<?php echo e(asset('images/logoIncuvalabRemovebg.png')); ?>"  alt="Incuvalab" width="193" height="43" border="0" style="border: none; display: block; -ms-interpolation-mode: bicubic;">
												</a>
											</td>	
										</tr>
															...
															<td align="center">
																<div border="0" style="border: none; height: 60px;">
																	<p style="font-size: 18px; line-height: 24px; font-family: Verdana, Geneva, sans-serif; color: #444857; text-align: center; mso-table-lspace:0;mso-table-rspace:0;">
                                                                         El emprendiento <strong style=" color: #4A0026;"><?php echo $teamName; ?></strong> terminó su formulario de  <strong  style=" color: #4A0026;"><?php echo $form; ?></strong>. <br> <br>
...
</html><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_Jaldin\Incubadora_prototype_SJ\resources\views/emails/FormDone.blade.php ENDPATH**/ ?>