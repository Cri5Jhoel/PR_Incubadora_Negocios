                            ...
                            <div class="col mr-2">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div  ng-repeat="student in students | limitTo:1">
                                                ...
                                                <div *ngIf="student.phase === 1"  class="stepper-wrapper">
                                            ...
                                            <div *ngIf="student.phase ===2" class="stepper-wrapper">
                                            ...
                                            <div *ngIf="student.phase ===3" class="stepper-wrapper">
                                            ...
                                            <div *ngIf="student.phase ===4" class="stepper-wrapper">
                                                    <div class="stepper-item completed">
                                                        <div class="step-counter">1</div>
                                                        <div class="step-name">Propuesta de valor</div>
                                                    </div>
                                            ...
                                            <div *ngIf="student.phase ===5" class="stepper-wrapper">
                                                    <div class="stepper-item completed">
                                                        <div class="step-counter">1</div>
                                                        <div class="step-name">Propuesta de valor</div>
                                                    </div>
                                            ...
                                            <div *ngIf="student.phase ===6" class="stepper-wrapper">
                                                    <div class="stepper-item completed">
                                                        <div class="step-counter">1</div>
                                                        <div class="step-name">Propuesta de valor</div>
                                                    </div>
                                            ...
                                            <div *ngIf="student.phase ===7" class="stepper-wrapper">
                                                    <div class="stepper-item completed">
                                                        <div class="step-counter">1</div>
                                                        <div class="step-name">Propuesta de valor</div>
                                                    </div>
...
<?php echo $__env->make("layouts.Dashboard", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Santiago Jaldin\Downloads\Incubadora_prototype\Incubadora_prototype\resources\views/team/members.blade.php ENDPATH**/ ?>