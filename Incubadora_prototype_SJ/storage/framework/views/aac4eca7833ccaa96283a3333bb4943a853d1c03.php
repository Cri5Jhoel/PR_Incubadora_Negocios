    ...
    angular.element(document).ready(() => {
        ...
        if (userType == "teacher") {
            ...
            $http.get('/verifiedTeacher/'+teamId).then((res) =>{
                ...
                var newStatusAprob = s[0]+","+s[1] +"," +s[2] + ","+s[3] + ",3,1,"+s[6];
            ...
            <div id="content" class="card-body">
                <form action="#" class="form">
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <h4 for="" class="text-left">Crea y define la mejor estrategia de precios para cada segmento
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\teran\Downloads\Incubadora_prototype_SJ\resources\views/form5.blade.php ENDPATH**/ ?>