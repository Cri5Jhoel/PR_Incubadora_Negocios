                ...
                <form action="#" class="form">
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <textarea type="" class="form-control " name="" ng-model="input1" id="input1" aria-describedby="helpId" placeholder=""></textarea>
                            <label for="">Visión</label>
                            <textarea type="" class="form-control " name="" ng-model="input2" id="input2" aria-describedby="helpId" placeholder=""></textarea>
                            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div>
                                <div class="table-responsive">
                                    <input type="text" class="form-control" name="" ng-model="input28" id="input28" aria-describedby="helpId" placeholder="" readonly>
                            ...
                            <div>
                                <div class="table-responsive">
                                    <input type="text" class="form-control" name="" ng-model="input35" id="input35" aria-describedby="helpId" placeholder="" readonly>
                                    <table class="table text-white table-borderless">
                                        <thead>
                                            <th scope="col">
                                                <div class="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <input type="text" class="form-control" name="" ng-model="input39" id="input39" aria-describedby="helpId" placeholder="">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div>
                                                        <input type="text" class="form-control" name="" ng-model="input40" id="input40" aria-describedby="helpId" placeholder="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                            ...
                            <div>
                                <div class="table-responsive">
                                    <input type="text" class="form-control" name="" ng-model="input42" id="input42" aria-describedby="helpId" placeholder="" readonly>
                                    <table class="table text-white table-borderless">
                                        <thead>
                                            <th scope="col">
                                                <div class="">
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input55" id="input55" aria-describedby="helpId" placeholder="">
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input66" id="input66" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input70" id="input70" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input74" id="input74" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input78" id="input78" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input82" id="input82" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input86" id="input86" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input90" id="input90" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input92" id="input92" aria-describedby="helpId" placeholder="" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div>
                            ...
                            <table class="table text-white table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input108" id="input108" placeholder="">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input111" id="input111" placeholder="">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" class="form-control" name="" ng-model="input114" id="input114" placeholder="">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <textarea type="" class="form-control " name="" ng-model="input115" id="input115" aria-describedby="helpId" placeholder=""></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\EQUIPO\Documents\Univalle 3\Proyecto de Sistemas\MisEdicionesGitHub\Incubadora_prototype_Valdivia\Incubadora_prototype\resources\views/form7.blade.php ENDPATH**/ ?>